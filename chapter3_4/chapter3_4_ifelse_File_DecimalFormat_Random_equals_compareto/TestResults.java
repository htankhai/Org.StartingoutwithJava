...
/**
   ...
   displays a letter grade for the score. The program displays an error message 
   if an invalid numeric score is entered.
 */
...
public class TestResults
{
	public static void main(String[] args)
	{
		...
		if (testScore < 60)
			...
			JOptionPane.showMessageDialog(null, "Your grade is invalid.");
