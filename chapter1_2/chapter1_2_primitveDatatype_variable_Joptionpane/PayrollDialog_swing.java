 ...
 */
public class PayrollDialog_swing
{
	public static void main(String[] args)
	{
		//create fileds in String, int and double types
		...
		// Get the hourly pay rate argument
		...
		// End the program of JOptionPane class
		System.exit(0);
	}
}