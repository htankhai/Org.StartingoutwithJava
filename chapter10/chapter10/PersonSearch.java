...
public class PersonSearch{
   public static void main(String[] args)
   {
      ...
      // Create an array of names.//" last name, first name"
      String[] people = { 
    		  			"Khai,  Htan", "Cutshaw, Will", "Davis, George",
    		  			"Davis,Jenny", "Russert, Phil", "Russell, Cindy", 
    		  			"Setzer, Charles", "Smathers, Holly", "Smith, Chris",
