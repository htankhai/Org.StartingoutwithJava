...
public class CalcAverage
{
	public static void main(String[] args)
	{
		...
		for (int index = 0; index < numScores; index++)
		{
			...
			System.out.println(" Entered score : " + (index + 1)+ " is " +scores[index] );
		}

		showArray(scores);
		System.out.println();

		// Create a Grader object, passing the scores array as an argument to the
		// constructor.
	...
	{
		System.out.print("Enterd scores are ");
