package chapter7_8;
/**
	This program demonstrates a method that accepts a mixture of fixed arguments 
...
public class VarargsDemo3
{
   ...
   /**
   	The courseAverage method accepts the name of a course and a variable number of 
   	test scores as arguments. The variable-length parameter,scores, must be the last one 
